...
class CartList extends Component {
    state = {
        cart: [{
            id: "00000",
            name: "Cakeunit",
            title: "Sweet's syndrome is a rare skin condition. Its main signs include fever and painful skin lesions that appear mostly on your arms, neck, head and trunk. The exact cause of Sweet's syndrome isn't known. In some people, it's triggered by an infection, illness or certain medications. Sweet's syndrome can also occur with some types of cancer.",
            detail: "unhealth",
            price: 99.9,
            unit: "piece",
            quantity: 2,
